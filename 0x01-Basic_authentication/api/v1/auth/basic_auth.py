...
from .auth import Auth  # Assuming this import is correct
...
class BasicAuth(Auth):
    ...
    def extract_base64_authorization_header(
        ...
        Returns:
            str: The Base64 token if found, otherwise None.
        """
    ...
    def extract_user_credentials(
        ...
        """
        Extracts user credentials from a decoded
        ...
        Returns:
            Tuple[str, str]: User email and password tuple if found,
            otherwise (None, None).
        """
    ...
    def user_object_from_credentials(
        ...
        Returns:
            TypeVar('User'): User object if authentication
    ...
    def current_user(self, request=None) -> TypeVar('User'):
        """
        Retrieves the current user object from the request.

        Args:
            request: Flask request object.

        Returns:
            TypeVar('User'): Current user object if authenticated,
            otherwise None.
        """
